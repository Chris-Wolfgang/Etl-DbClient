...
param(
    [Parameter()]
    [string]$Repository = "Chris-Wolfgang/Etl-DbClient",
...
if ($Repository -eq "Chris-Wolfgang/Etl-DbClient" -or -not $Repository) {
    ...
    try {
        ...
        if ($Repository -eq "Chris-Wolfgang/Etl-DbClient") {
