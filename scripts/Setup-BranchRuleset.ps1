...
param(
    [Parameter()]
    [string]$Repository = "@Chris-Wolfgang/Wolfgang.Etl.Ado",
...
if ($Repository -eq "@Chris-Wolfgang/Wolfgang.Etl.Ado" -or -not $Repository) {
    ...
    try {
        ...
        if ($Repository -eq "@Chris-Wolfgang/Wolfgang.Etl.Ado") {
